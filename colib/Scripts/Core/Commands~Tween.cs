namespace CoLib
{
    public static partial class Cmd
    {
        ...
        public static CommandDelegate ChangeTo(Ref<float> single, float endSingle, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
            float startSingle = 0.0f;
            return Cmd.Sequence(
                Cmd.Do(delegate() { startSingle = single.Value; }),
                Cmd.Duration(delegate(double t) { single.Value = (endSingle - startSingle) * (float) t + startSingle; },
                    duration, ease)
            );
        }

        public static CommandDelegate ChangeTo(Ref<double> single, double endSingle, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
            ...
            return Cmd.Sequence(
                Cmd.Do(delegate() { startSingle = single.Value; }),
                Cmd.Duration(delegate(double t) { single.Value = (endSingle - startSingle) * t + startSingle; },
                    duration, ease)
            );
        }

        public static CommandDelegate ChangeTo(Ref<short> single, short endValue, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
        ...
        public static CommandDelegate ChangeTo(Ref<long> single, long endValue, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
        ...
        public static CommandDelegate ChangeBy(Ref<float> single, float offset, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
            double lastT = 0.0;
        ...
        public static CommandDelegate ChangeBy(Ref<double> single, double offset, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
        ...
        public static CommandDelegate ChangeBy(Ref<short> single, short offset, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
        ...
        public static CommandDelegate ChangeFrom(Ref<float> single, float startSingle, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
            ...
            return Cmd.Sequence(
                Cmd.Do(delegate() { endSingle = single.Value; }),
                Cmd.Duration(delegate(double t) { single.Value = (endSingle - startSingle) * (float) t + startSingle; },
                    duration, ease)
            );
        }

        public static CommandDelegate ChangeFrom(Ref<double> single, double startSingle, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
        ...
        public static CommandDelegate ChangeFrom(Ref<short> single, short startValue, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
        ...
        public static CommandDelegate ChangeFrom(Ref<int> single, int startValue, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
        ...
        public static CommandDelegate ChangeFrom(Ref<long> single, long startValue, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(single, "single");
        ...
        public static CommandDelegate ChangeFrom<T>(IInterpolatable<T> interpolatable, T startValue, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(interpolatable, "interpolatable");
            ...
            return Cmd.Sequence(
                Cmd.Do(delegate() { endValue = interpolatable.GetValue(); }),
                Cmd.Duration(delegate(double t) { interpolatable.Interpolate(startValue, endValue, t); }, duration,
                    ease)
            );
        }

        public static CommandDelegate ChangeFrom<T>(Ref<T> val, T startValue, IInterpolator<T> interpolator,
            double duration, CommandEase ease = null) where T : struct
        {
            CheckArgumentNonNull(val, "val");
            CheckArgumentNonNull(interpolator, "interpolator");
            ...
            return Cmd.Sequence(
                Cmd.Do(delegate() { endValue = val.Value; }),
                Cmd.Duration(delegate(double t) { val.Value = interpolator.Interpolate(startValue, endValue, t); },
                    duration, ease)
            );
        }
        ...
        public static CommandDelegate ScaleBy(Ref<float> scale, float scaleFactor, double duration,
            CommandEase ease = null)
        {
            ...
            return Cmd.Sequence(
                Cmd.Do(delegate() { lastScaleFactor = 1.0f; }),
                Cmd.Duration(delegate(double t)
                {
        ...
        public static CommandDelegate ScaleBy(Ref<double> scale, double scaleFactor, double duration,
            CommandEase ease = null)
        {
            CheckArgumentNonNull(scale, "scale");
            ...
            return Cmd.Sequence(
                Cmd.Do(delegate() { lastScaleFactor = 1.0; }),
                Cmd.Duration(delegate(double t)
                {
