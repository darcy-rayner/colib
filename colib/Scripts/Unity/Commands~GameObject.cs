...
namespace CoLib
{
	...
	public static partial class Cmd
	{
		...
		public static CommandDelegate MoveTo(GameObject gameObject, Vector3 endPosition, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
			return MoveTo(gameObject.transform, endPosition, duration, ease, isLocalSpace);
		}

		public static CommandDelegate MoveTo(Transform transform, Vector3 endPosition, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
		...
		public static CommandDelegate MoveBy(GameObject gameObject, Vector3 offset, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate MoveBy(Transform transform, Vector3 offset, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate MoveFrom(GameObject gameObject, Vector3 startPosition, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate MoveFrom(Transform transform, Vector3 startPosition, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate RotateTo(GameObject gameObject, Quaternion endRotation, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate RotateTo(Transform transform, Quaternion endRotation, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate RotateBy(GameObject gameObject, Quaternion endRotation, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate RotateBy(Transform transform, Quaternion endRotation, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate RotateFrom(GameObject gameObject, Quaternion startRotation, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate RotateFrom(Transform transform, Quaternion startRotation, double duration,
			CommandEase ease = null, bool isLocalSpace = false)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate ScaleTo(GameObject gameObject, float endScale, double duration,
		...
		public static CommandDelegate ScaleTo(GameObject gameObject, Vector3 endScale, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate ScaleTo(Transform transform, float endScale, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate ScaleTo(Transform transform, Vector3 endScale, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate ScaleBy(GameObject gameObject, float scaleFactor, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate ScaleBy(GameObject gameObject, Vector3 scaleFactor, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate ScaleBy(Transform transform, float scaleFactor, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate ScaleBy(Transform transform, Vector3 scaleFactor, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate ScaleFrom(GameObject gameObject, float startScale, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate ScaleFrom(GameObject gameObject, Vector3 startScale, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate ScaleFrom(Transform transform, float startScale, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate ScaleFrom(Transform transform, Vector3 startScale, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(transform, "transform");
		...
		public static CommandDelegate TintTo(GameObject gameObject, Color endColour, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate TintTo(Renderer renderer, Color endColour, double duration,
			CommandEase ease = null)
		{
		...
		public static CommandDelegate TintTo(Material material, Color endColour, double duration,
			CommandEase ease = null)
		{
		...
		public static CommandDelegate TintTo(SpriteRenderer renderer, Color endColour, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(renderer, "renderer");
		...
		public static CommandDelegate TintBy(GameObject gameObject, Color offset, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate TintBy(SpriteRenderer renderer, Color offset, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(renderer, "renderer");
		...
		public static CommandDelegate TintFrom(GameObject gameObject, Color startColour, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate TintFrom(Renderer renderer, Color startColour, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(renderer, "renderer");
		...
		public static CommandDelegate TintFrom(Material material, Color startColour, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(material, "material");
		...
		public static CommandDelegate TintFrom(SpriteRenderer renderer, Color startColour, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(renderer, "renderer");
		...
		public static CommandDelegate AlphaTo(GameObject gameObject, float endAlpha, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate AlphaTo(Renderer renderer, float endAlpha, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(renderer, "renderer");
		...
		public static CommandDelegate AlphaTo(Material material, float endAlpha, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(material, "material");
		...
		public static CommandDelegate AlphaTo(SpriteRenderer renderer, float endAlpha, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(renderer, "renderer");
		...
		public static CommandDelegate AlphaBy(GameObject gameObject, float offset, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate AlphaBy(SpriteRenderer renderer, float offset, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(renderer, "renderer");
		...
		public static CommandDelegate AlphaFrom(GameObject gameObject, float startAlpha, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(gameObject, "gameObject");
		...
		public static CommandDelegate AlphaFrom(Renderer renderer, float startAlpha, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(renderer, "renderer");
		...
		public static CommandDelegate AlphaFrom(Material material, float startAlpha, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(material, "material");
		...
		public static CommandDelegate AlphaFrom(SpriteRenderer renderer, float startAlpha, double duration,
			CommandEase ease = null)
		{
			CheckArgumentNonNull(renderer, "renderer");
