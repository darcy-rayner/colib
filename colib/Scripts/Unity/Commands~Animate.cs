...
namespace CoLib
{
    ...
    public static partial class Cmd
    {
        ...
        {
            CheckArgumentNonNull(scale, "scale");
            return ScaleSquashAndStretchTo(scale, endScale, amplitude, duration, Vector3.up,
        ...
        {
            CheckArgumentNonNull(scale, "scale");
            return ScaleSquashAndStretchFrom(scale, startScale, amplitude, duration, Vector3.up,
                new Vector3(0.5f, 0f, 0.5f).normalized);
        }
