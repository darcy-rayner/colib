...
using UnityEngine.UI;
 ...
 namespace CoLib
 {
     ...
     public static partial class Cmd
     {
         ...
         public static CommandDelegate TintFrom(Graphic graphic, Color startColor, double duration,
         ...
         public static CommandDelegate AlphaFrom(CanvasGroup group, float alpha, double duration,
             CommandEase ease = null)
         {
             CheckArgumentNonNull(group, "group");
         ...
         public static CommandDelegate ScaleTo(RectTransform transform, Vector2 endScale, double duration,
             CommandEase ease = null)
         {
         ...
         public static CommandDelegate ScaleFrom(RectTransform transform, Vector2 startScale, double duration,
             CommandEase ease = null)
         {
             CheckArgumentNonNull(transform, "transform");
         ...
         public static CommandDelegate ScaleBy(RectTransform transform, Vector2 scaleFactor, double duration,
             CommandEase ease = null)
         {
             CheckArgumentNonNull(transform, "transform");
